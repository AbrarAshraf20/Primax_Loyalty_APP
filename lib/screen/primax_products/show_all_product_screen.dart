...
import 'package:primax/screen/primax_products/product_details_screen.dart';

import '../../widgets/searchbar_widget.dart';
import 'comman_back_button.dart';

class ShowAllProductScreen extends StatefulWidget {
  ShowAllProductScreen({required this.brandName,super.key});
  String brandName;
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('${widget.brandName} Products',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
        centerTitle: true,
      ),
          ...
          SliverFillRemaining(
            child: Padding(
              ...
              child: UnifiedProductGrid(
                query: query,
                selectedBrand: widget.brandName,
              ),
            ),
          ),
        ],
